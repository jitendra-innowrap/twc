                ...
                <section className="section-padding mt-15 mb-25">
                    <div className="container wow fadeIn animated">
                        ...
                        <div className="container mt-70">
                            ...
                            <div className="rental-banner mt-20">
                                <div
                                    className="rental-category-card-img image-press wow fadeIn animated mb-md-4 mb-sm-4 mb-lg-0"
                                >
                                    <img src="/assets/imgs/banner/rental-banner-1.jpg" alt="" />
                                </div>
                            </div>
                ...
                <section className="section-padding usp-section">
                    ...
                    <div className="container pt-25 pb-25">
                        <div className="head d-flex justify-content-between align-items-start mb-50">
                            ...
                            <div className="right">
                                <button className="btn title-btn">Plan Your Event</button>
                            </div>
                        </div>
