                                        ...
                                        {/* <div className="social-icons single-share">
                                            <ul className="text-grey-5 d-inline-block">
                                                ...
                                                <li className="social-x">
                                                    <a href={`https://twitter.com/intent/tweet?text=Check out this product:https://thepartycafe.com/products/detail/${productDetails?.handle}`}
                                                    target="_blank">
                                                        <FaXTwitter size={18} color="#606060" />
                                                    </a>
                                                </li>
                                                <li className="social-whatsapp">
                                                    <a href={`https://wa.me/send?text=Check out this product:https://thepartycafe.com/products/detail/${productDetails?.handle}`} 
                                            ...
                                            <div className="detail-extralink">
                                                <div className="product-extra-link2">
                                                    <a href={`https://wa.me/+919892745795/?text=Hi i'm interested in this product: 
                                                               https://thepartycafe.com/products/detail/${productDetails?.handle}        
                                                    `}
                                                        className="connect"
                                                        target="_blank"
                                                    >
