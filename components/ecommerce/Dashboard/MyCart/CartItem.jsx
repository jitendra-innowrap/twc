                ...
                <div className="itemContainer-base-item">
                    ...
                    <div className="itemContainer-base-itemRight">
                        <div className="itemContainer-base-details" onClick={()=>{console.log(item)}}>
                            ...
                            {(item.product_type == "1" && item?.deposit_amount) &&<div class="returnPeriod-base-returnItem">
                                ...
                                <div class="returnPeriod-base-returnText">
                                    <span class="returnPeriod-base-returnDays">₹{item.deposit_amount}</span> Refundable deposite for 5 days rental
                                </div>
                            </div>}
                        </div>
                    </div>
